# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 19:12:31 2019
...
def Detect(img):
    ...
    gray_frame = cv2.medianBlur(grayImg, 5)
    #cv2.imshow("Median Blur", gray_frame)
    faces = face_cascade.detectMultiScale(gray_frame, 1.02, 10, 0 | cv2.CASCADE_SCALE_IMAGE, (30, 30))
    detected = 0
